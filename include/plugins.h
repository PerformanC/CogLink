...
struct pluginEvents {
  ...
  int (*onDecodeTrackCleanup)(struct lavaInfo *lavaInfo, struct parsedTrack **songStruct);
};
...
struct pluginEventsInternal {
  ...
  int (*onDecodeTrackCleanup[8])(struct lavaInfo *lavaInfo, struct parsedTrack **songStruct);
};
